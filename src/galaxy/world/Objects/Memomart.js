...
export default class Memomart extends OrbitingObject {
    ...
    constructor(orbitTarget) {
        ...
        const info = new ObjectInformation({
            ...
            summary: "Turn curiousity into memorable moments with others.<br><br>This is a product I am tackling with some friends where we are providing its users a simple experience that rewards presence, and cooporation.",
