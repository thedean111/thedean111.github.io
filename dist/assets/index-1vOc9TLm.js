...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ai,depthTest:!1,depthWrite:!1})}function Bu(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pc(),fragmentShader:`
		...
		`,blending:ai,depthTest:!1,depthWrite:!1})}function ku(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pc(),fragmentShader:`
