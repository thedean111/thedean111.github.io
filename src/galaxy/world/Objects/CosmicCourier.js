...
export default class CosmicCourier extends OrbitingObject {
    ...
    constructor(orbitTarget) {
        ...
        const info = new ObjectInformation({
            ...
            summar: "Educational game prototype that targets STEM education in young students through the implementation of STEM concepts as 'serious' game mechanics. Developed in response to game-based learning implementation challenges discovered in the relevant educational technology literature.",
