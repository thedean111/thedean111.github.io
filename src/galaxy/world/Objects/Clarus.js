...
export default class Clarus extends OrbitingObject {
    ...
    constructor(orbitTarget) {
        ...
        const info = new ObjectInformation({
            ...
            body: "Tools:<br>Arduino (C++), Basic Electronics<br><br>At Clarus I contributed to the software development of the CILA 2 Fiber Optic Polishing System. This work included:<br>- Refactoring of the existing codebase,<br>- Usability improvements on the LCD user interface,<br>- Development of smoothing algorithms for raw inertial measurement unit (IMU) data.",
