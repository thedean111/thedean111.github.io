...
export default class Dean extends OrbitingObject {
    ...
    constructor(orbitTarget) {
        ...
        const info = new ObjectInformation({
            ...
            body: "This website is a creative manifestion of my portfolio! It documents most of my skills and the projects that I feel proud to show.<br><br>This telemetry screen was created to provide a more typical webpage experience while still trying to fit in the themes of the project.",
