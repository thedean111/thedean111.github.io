...
export default class PersonalPlanet extends OrbitingObject {
    ...
    constructor(orbitTarget) {
        ...
        const info = new ObjectInformation({
            ...
            summary: "I have always loved to create things. Unfortunately, since LEGO discontinued the Bionicle line in 2010 I had to find my outlet elsewhere. So, I picked up arts, crafts, and, eventually, some more technical hobbies!<br><br><br>LEGO® is a trademark of the LEGO Group of companies which does not sponsor, authorize or endorse this site",
            body: "For many years I have enjoyed creativity and arts, and as my technical capabilities grow I proportionally expand the scope of my projects. <br><br>From woodworking, to 3D printing, to painting, to software development, I have always felt the most joy when watching my ideas bloom to tangibility.<br><br>This category presents the personal projects I am most proud of, along with the more substantial MEM-O-MART venture I am tackling with friends!",
